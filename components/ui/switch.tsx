  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        'data-[state=checked]:bg-accent data-[state=unchecked]:bg-surface-2 data-[state=unchecked]:border-border',
        className,
      )}
      {...props}
    >
      <SwitchPrimitive.Thumb
        className={cn(
          ...
          'data-[state=checked]:translate-x-5 data-[state=checked]:bg-accent-foreground data-[state=unchecked]:translate-x-0.5',
        )}
      />
    </SwitchPrimitive.Root>
  );
